...
public class mecha_mkI_copy<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "mecha_mki_copy"), "main");
	private final ModelPart whole;

	public mecha_mkI_copy(ModelPart root) {
