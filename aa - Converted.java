...
public class aa - Converted<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r5 = ll_top_2.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(199, 137).addBox(38.0F, -1.2F, -1.1F, 17.0F, 42.4F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));
		...
		PartDefinition ll_bottom = ll_subpart_2.addOrReplaceChild("ll_bottom", CubeListBuilder.create().texOffs(66, 233).addBox(34.9F, -25.3F, -31.9F, 18.3F, 27.0F, 17.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
