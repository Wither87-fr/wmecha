...
import fr.wither.mecha.entity.animations.ModAnimationDefinitions;
...
public class MK1Model<T extends Entity> extends HierarchicalModel<T> {
	private final ModelPart whole;

	public MK1Model(ModelPart root) {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(((MK1Entity) entity).idleAnimationState, ModAnimationDefinitions.IDDLE, ageInTicks, 1f);
	}
